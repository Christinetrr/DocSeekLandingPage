...
export function App() {
	...
	return (
		<div className="relative min-h-screen doc-grid-bg">
			<header className="sticky top-0 z-50 border-b border-white/[0.06] bg-[#050816]/75 backdrop-blur-md">
						...
						<div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
							<div>
								...
								<p className="mt-4 text-doc-muted">
									Open the app to describe symptoms or goals in your own words,
									then refine by location and whether physicians are accepting
									new patients.
								</p>
								<a
									href={appHome}
								...
								<p className="mt-4 text-sm text-doc-muted">
									The clip mirrors your live search screen — raised shadow, cyan
									accents, and the same prompt as in the product.
								</p>
							</div>
						...
						<div className="grid gap-10 lg:grid-cols-2 lg:items-center">
							<div>
								...
								<p className="mt-4 text-doc-muted">
									...
									and compare public profile information. Always confirm details
									with the clinic or insurer before booking.
								</p>
							...
							<div className="rounded-2xl border border-violet-400/25 bg-linear-to-br from-violet-500/10 to-teal-500/5 p-8">
								...
								<p className="mt-2 text-doc-muted">
									Jump into the search experience — your next visit starts with
									better directions.
								</p>
								<a
									href={appHome}
			...
			<footer className="border-t border-white/[0.06] py-10">
				<div className="mx-auto max-w-6xl px-4 text-center text-xs text-doc-muted sm:px-6">
					<p>
						...
						you are experiencing an emergency, call your local emergency number.
					</p>
					<p className="mt-3">
						&copy; {new Date().getFullYear()} DocSeek. UPMC name used
						descriptively to identify the health system directory ecosystem;
						DocSeek is not endorsed by or affiliated with UPMC unless separately
						stated in writing.
					</p>
				</div>
			</footer>
			...
			<nav
				className="fixed bottom-4 left-1/2 z-40 flex -translate-x-1/2 gap-1 rounded-full border border-white/[0.1] bg-[#050816]/92 px-2 py-2 shadow-lg backdrop-blur-md md:hidden"
